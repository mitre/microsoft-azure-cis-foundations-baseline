...
insight into changes to the active security solutions and may reduce the time
...
Administrative Activity Log \"Delete Security Solutions (securitySolutions)\"
...
and
.equals==\"microsoft.security/securitysolutions/delete\"),enabled:.properties.enabled}'
    ```
  ...
  desc  "fix", "
    **Azure Command Line Interface 2.0**
    ...
    Use the below command to create an Activity Log Alert for `Delete Security
Solutions`
