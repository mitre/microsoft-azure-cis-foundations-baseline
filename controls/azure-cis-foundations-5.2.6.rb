control "azure-cis-foundations-5.2.6" do
  title "Ensure that Activity Log Alert exists for Create or Update Security
Solution"
  desc  "Create an activity log alert for the Create or Update Security
Solution event."
  desc  "rationale", "Monitoring for Create or Update Security Solution events
gives insight into changes to the active security solutions and may reduce the
...
Administrative Activity Log \"Create or Update Security Solutions
(securitySolutions)\" has \"any\" level with \"any\" status and event is
initiated by \"any\"`
...
and
.equals==\"microsoft.security/securitysolutions/write\"),enabled:.properties.enabled}'
    ```
