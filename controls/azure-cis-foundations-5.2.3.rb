control "azure-cis-foundations-5.2.3" do
  title "Ensure that Activity Log Alert exists for Delete Network Security
Group"
  desc  "Create an activity log alert for the Delete Network Security Group
event."
  desc  "rationale", "Monitoring for \"Delete Network Security Group\" events
...
Administrative Activity Log \"Delete Network Security Group
...
and
.equals==\"microsoft.network/networksecuritygroups/delete\"),enabled:.properties.enabled}'
    ```
