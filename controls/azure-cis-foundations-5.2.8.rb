...
Server Firewall Rule event."
  desc  "rationale", "Monitoring for Create or Update or Delete SQL Server
Firewall Rule events gives insight into network access changes and may reduce
...
Administrative Activity Log \"Create/Update server firewall rule
...
and
.equals==\"microsoft.sql/servers/firewallrules/write\"),enabled:.properties.enabled}'
    ```
